/*
    ...
    HUMDANS MODIFIED:::: REPETIER  VERSION 1.5
    reprap calibrations:
   ...
   y axis step loss fix
      ...
      -SD DETECT enabled
      -EEPROM set to -1 to disable all EEPROM settings 3/24/2014
...
// ##########################################################################################
    ...
    #define XAXIS_STEPS_PER_MM 5  // 5.56
    /** \brief Number of steps for a 1mm move in y direction.
    For xy gantry use 2*belt moved!
    Overridden if EEPROM activated.*/
    #define YAXIS_STEPS_PER_MM 5  // 5.56
...
#define EXT0_STEPS_PER_MM 40.2 //413 //385
...
//  Overridden if EEPROM activated.s
#define EXT0_MAX_FEEDRATE 60
// Feedrate from halted extruder in mm/s
//  Overridden if EEPROM activated.
#define EXT0_MAX_START_FEEDRATE 60
// Acceleration in mm/s^2
//  Overridden if EEPROM activated.
...
#define EXT0_PID_P   23.17
/** I-gain. Overridden if EEPROM activated.
*/
#define EXT0_PID_I   2.39
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 56.17
...
/** \brief X, Y, Z max acceleration in mm/s^2 for printing moves or retracts. Make sure your printer can go that high! 
 Overridden if EEPROM activated.
*/
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 600  // 3000
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 600  // 3000
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 100 

/** \brief X, Y, Z max acceleration in mm/s^2 for travel moves.  Overridden if EEPROM activated.*/
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 600  // 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 600  // 3000
...
The jerk determines your start speed and the mfsteaximum speed at the join of two segments.
...
#define UI_VERSION_STRING2 "HH-BOT"
