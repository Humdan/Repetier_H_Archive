...
#define LED_PIN            13
#define ORIG_FAN_PIN            8  // MODIFIED 2.6
#define PS_ON_PIN          12    // modify this for pS_on

#define HEATER_0_PIN       10 // HEATER0
#define HEATER_1_PIN       9  // HEATER1
#define HEATER_2_PIN       8  // ALL COOLERS/ LIGHTS
