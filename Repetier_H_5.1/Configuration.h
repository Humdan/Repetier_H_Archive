/*
  Repetier Configuration for RADDS v1.5 board
  v5.1

  extruder 1 temp sensor unmapped to -1  for radds basic desktop testing
  extruder count changed from 2 to 1
  feature controller set to 0 for testing
  removed ext1 settings
...
#define UI_PRINTER_NAME "doMaker"
