...
RGB LED control
ATX PSU ON/OFF
Cooling FAN AUTO TEMP CHECK
]]yttttttytyyychanged minimum tempj   
...
CUSTOM MADE NEW VERSION REPETIER_H 2.0

This file is part of Repetier-Firmware.
 VERSION 1.6 EMBEDDED WITH VIKI SUPPORT
 
 1.6 E3D DIRECT DRIVE EXTRUDER
 1.5 implements XY acceleration match
 
 
 
 1.4 implements smooth motion less jerk on Y axis
 y axis step loss IMPROVE
 - slower acceleration
 - 20mm offset for second take during homing
 
 Extruder Feedrate Set  mm/s
 - extruder steps  upgraded
 -
 1.3 implements SD support
 VIKI LCD CONTROLLER 5 SUPPORT
 FULL VIKI LCD SUPPORT
 ENCODER_ROTARY IMPLEMENTED
 BTNA,BTNB,BTN_ENC
